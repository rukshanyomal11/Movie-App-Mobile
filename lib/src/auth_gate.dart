    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const SizedBox(height: 20),
          const Text(
            'Book premium seats, catch the latest releases, and track every ticket beautifully.',
            style: TextStyle(
              color: AppColors.textPrimary,
              fontSize: 24,
              fontWeight: FontWeight.w800,
          ...
          const SizedBox(height: 14),
          const Text(
            'Designed for fast bookings and smooth cinema nights.',
            style: TextStyle(
              color: Color(0xFFE5C8D1),
              fontSize: 15,
              fontWeight: FontWeight.w500,
            ),
          ),
